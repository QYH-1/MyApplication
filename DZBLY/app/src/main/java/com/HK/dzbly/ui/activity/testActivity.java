...
//import com.HK.dzbly.utils.wifi.ListenerThread;
//
...
//       //wifi_list_item listView.setAdapter(wifiListAdapter);
//
...
//                        new AlertDialog.Builder(testActivity.this).setTitle("请输入Wifi密码").setIcon(
...
//                    text_state.setText("已连接到网络:" + wifiInfo.getSSID()+"111");
//                    Log.d("AAA232","wifiInfo.getSSID():"+wifiInfo.getSSID()+"  WIFI_HOTSPOT_SSID:"+WIFI_HOTSPOT_SSID);
//
