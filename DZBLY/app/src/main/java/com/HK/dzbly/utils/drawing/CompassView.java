...
public class CompassView extends View {
    ...
    private void drawCompassCircum() {
        ...
        mCanvas.drawArc(new RectF(width / 2 - mCircumRadius, mTextHeight + mOutSideRadius - mCircumRadius, width / 2 + mCircumRadius, mTextHeight + mOutSideRadius + mCircumRadius), -85, 350, false, mDeepGrayPaint);
