 ...
 * 修订历史：
 */
public class Accumulative_rangingDrawing extends View {
    // 用于存放将要画线的点
    ...
    public Accumulative_rangingDrawing(Context context) {
        super(context);
    }

    public Accumulative_rangingDrawing(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public Accumulative_rangingDrawing(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
