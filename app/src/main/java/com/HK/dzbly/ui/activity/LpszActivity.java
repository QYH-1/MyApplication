...
public class LpszActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取GPS权限
        ActivityCompat.requestPermissions(LpszActivity.this, new String[]
        ...
        result = sp.getString("declination", "2.38");
        declination.setText(result);
            ...
            public void onClick(View view) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        result = utils.getServiceInfo(strUrlPath);
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                declination.setText(result);
                                DecimalFormat df = new DecimalFormat("#.00");
                                result =String.valueOf(df.format(Double.parseDouble(result)));
                                Log.d("result",result);
                                SharedPreferences.Editor editor = sp.edit();
                                editor.putString("declination", result);
                                editor.commit();
                            }
                        });
                    }
