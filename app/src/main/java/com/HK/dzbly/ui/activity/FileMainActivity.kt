...
class FileMainActivity : AppCompatActivity(), OnclickInterfaceFile, SearchView.OnQueryTextListener,
    ...
    internal var handler: Handler = object : Handler() {// 内部类
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (msg.what == 1) {// UI 线程的回调处理
                ...
                Toast.makeText(this@FileMainActivity, "文件数:" + list.size, Toast.LENGTH_LONG).show()
                update_sort()
            }
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.sort_name) {
            ...
            desc1 = view.findViewById(R.id.desc1) as TextView
            desc1.setText(timeStamp)
            //显示确认框
            AlertDialog.Builder(this@FileMainActivity)
                .setTitle("系统提示")
                .setView(view)
